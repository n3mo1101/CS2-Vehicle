...
namespace Vehicle_Version_2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine($"{car.ToString()} for {distance} km: {car.CalculateFuelConsumption(distance):F2} liters");
                Console.WriteLine($"{motorcycle.ToString()} for {distance} km: {motorcycle.CalculateFuelConsumption(distance):F2} liters");
                Console.WriteLine($"{truck.ToString()} for {distance} km with {cargoWeight} tons cargo: {truck.CalculateFuelConsumption(distance, cargoWeight):F2} liters");
            }
    ...
    class Car : Vehicle
    {
        ...
        {
            return $"Car (ID: {VehicleId}, Model: {Make} {Model})";
        }
    }
    ...
    class Motorcycle : Vehicle
    {
        ...
        public override string ToString()
        {
            return $"Motorcycle (ID: {VehicleId}, Model: {Make} {Model})";
        }
    ...
    class Truck : Vehicle
    {
        ...
        public override float CalculateFuelConsumption(float distance)
        {
            throw new NotSupportedException("Error: Try CalculateFuelConsumption(float distance, float cargoWeight)");
        }
        ...
        public override string ToString()
        {
            return $"Truck (ID: {VehicleId}, Model: {Make} {Model})";
        }
    }
}
